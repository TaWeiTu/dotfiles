...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("Search", s:background, s:foreground, "")
	...
	call <SID>X("Question", s:selection, "", "")
	...
	if version >= 700
		...
		call <SID>X("CursorLineNr", s:grey, "", "none")
		call <SID>X("WildMenu", "", s:foreground, "none")
    ...
    augroup ft_c
        autocmd!
        autocmd Syntax cpp syn match cFunction "\<[a-zA-Z_][a-zA-Z_0-9]*\>[^()]*)("me=e-2 
        autocmd Syntax cpp syn match cFunction "\<[a-zA-Z_][a-zA-Z_0-9]*\>\s*("me=e-1 
        "autocmd Syntax cpp hi cFunction gui=NONE guifg=#287bc1
    augroup end
    syn keyword pythonConstant	False None True
    "hi link pythonConstant Constant
    call <SID>X("pythonConstant", s:orange, "", "")
  ...
  call <SID>X("Member", s:red, "", "")
    ...
    call <SID>X("cCustomFunc", s:purple, "", "")
    ...
    augroup filetype_js
      autocmd!
      autocmd Syntax js syn match jsFunction "\<[a-zA-Z_][a-zA-Z_0-9]*\>[^()]*)("me=e-2 
      autocmd Syntax js syn match jsFunction "\<[a-zA-Z_][a-zA-Z_0-9]*\>\s*("me=e-1 
      autocmd Syntax js hi jsFunction gui=NONE guifg=#B5A1FF
    augroup end
